// Custom implementation to generate seed.sql with hashed passwords
...
('vendor-1', 'ailab@projectgenie.com', '${vendorPassword}', 'Dr. Alan Turing', 'AI Research Lab', '+91 98765 00001', 'https://ui-avatars.com/api/?name=Dr+Alan&background=0D8ABC&color=fff', 'Expert in Machine Learning and Computer Vision algorithms.', 4.9, 8500, 42, true, true, 'active', CURRENT_TIMESTAMP),
('vendor-2', 'codemasters@projectgenie.com', '${vendorPassword}', 'Sarah Connor', 'Code Masters Pro', '+91 98765 00002', 'https://ui-avatars.com/api/?name=Sarah+C&background=E53935&color=fff', 'Full-stack web development and scalable architectures.', 4.8, 6200, 31, true, true, 'active', CURRENT_TIMESTAMP),
('vendor-3', 'pywizards@projectgenie.com', '${vendorPassword}', 'Guido van Rossum', 'Python Wizards', '+91 98765 00003', 'https://ui-avatars.com/api/?name=Python+W&background=FFB300&color=fff', 'Python automation, data science, and backend APIs.', 4.7, 4100, 18, true, true, 'active', CURRENT_TIMESTAMP),
('vendor-4', 'visionary@projectgenie.com', '${vendorPassword}', 'Elon M.', 'Visionary Tech UI', '+91 98765 00004', 'https://ui-avatars.com/api/?name=Vision+UI&background=43A047&color=fff', 'UI/UX design, Figma prototypes, and frontend aesthetics.', 4.9, 9300, 56, true, true, 'active', CURRENT_TIMESTAMP),
('vendor-5', 'mobileexperts@projectgenie.com', '${vendorPassword}', 'Steve J.', 'App Crafters', '+91 98765 00005', 'https://ui-avatars.com/api/?name=App+C&background=8E24AA&color=fff', 'Flutter and React Native mobile application development.', 4.6, 3800, 14, true, true, 'active', CURRENT_TIMESTAMP);
...
('user-1', 'vardhan@university.edu', '${userPassword}', 'Vardhan Kumar', '+91 98765 43210', 'JNTU Hyderabad', 'CSE', 2450, true, CURRENT_TIMESTAMP),
('user-2', 'student@college.edu', '${userPassword}', 'Student User', '+91 87654 32109', 'VIT University', 'ECE', 500, true, CURRENT_TIMESTAMP);

-- 📦 Seed Bundles
INSERT INTO "Bundle" ("id", "title", "subtitle", "tag", "price", "originalPrice", "color") VALUES
('bnd-1', 'Final Year Complete Bundle', 'Project + Report + PPT + Video', 'Best Value', 4999, 9999, -12280430),
('bnd-2', 'Mini Project Pack', 'Code + Report', 'Popular', 1499, 2999, -14575885),
('bnd-3', 'Research Paper Bundle', 'IEEE Base Paper + Implementation', 'Premium', 7999, 14999, -1499549);
`;
